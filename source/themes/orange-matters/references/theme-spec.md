...
- Use [the DashboardFrame contract](../../../foundation/component-contracts/layouts/dashboard-frame.md) for the layout contract and guardrails; copy the complete implementation from its linked asset.
...
Keep the [DashboardFrame contract](../../../foundation/component-contracts/layouts/dashboard-frame.md) as the source of truth. This file owns the shorter design rules only.
...
- [Alert](../../../foundation/component-contracts/components/alert.md)
- [Button](../../../foundation/component-contracts/components/button.md)
- [Card](../../../foundation/component-contracts/components/card.md)
- [ControlCard](../../../foundation/component-contracts/components/control-card.md)
- [Dialog](../../../foundation/component-contracts/components/dialog.md)
- [Field](../../../foundation/component-contracts/components/field.md)
- [Header](../../../foundation/component-contracts/components/header.md)
- [Heading](../../../foundation/component-contracts/components/heading.md)
- [ImageCard](../../../foundation/component-contracts/components/image-card.md)
- [Menubar](../../../foundation/component-contracts/components/menubar.md)
- [components/running-border.md](components/running-border.md)
- [DataTable](../../../foundation/component-contracts/components/table.md)
- [ToastProvider](../../../foundation/component-contracts/components/toast.md)
- [VisionStage](../../../foundation/component-contracts/components/vision-stage.md)
...
- Use the [Header contract](../../../foundation/component-contracts/components/header.md) and linked complete asset.
...
- Use the [Menubar contract](../../../foundation/component-contracts/components/menubar.md) and linked complete asset.
...
Use the [Button contract](../../../foundation/component-contracts/components/button.md) and linked complete asset.
...
- Use the [Field contract](../../../foundation/component-contracts/components/field.md) and linked complete asset.
...
- Use the [Card](../../../foundation/component-contracts/components/card.md), [ControlCard](../../../foundation/component-contracts/components/control-card.md), [Heading](../../../foundation/component-contracts/components/heading.md), [ImageCard](../../../foundation/component-contracts/components/image-card.md), and [DataTable](../../../foundation/component-contracts/components/table.md) contracts and linked complete assets.
...
- Use the [VisionStage contract](../../../foundation/component-contracts/components/vision-stage.md) for video/canvas/SVG overlay surfaces.
...
- Use the [Dialog](../../../foundation/component-contracts/components/dialog.md), [Alert](../../../foundation/component-contracts/components/alert.md), and [ToastProvider](../../../foundation/component-contracts/components/toast.md) contracts and linked complete assets.
