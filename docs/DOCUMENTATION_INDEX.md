...
| `package.json` | Maintainers/CI | Repository entry points for Skill build, freshness checks, validation, and both sample builds | active | Keep scripts as thin entry points; implementation details belong in the owning script. |
