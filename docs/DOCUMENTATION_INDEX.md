...
5. `skills/<theme>/SKILL.md` only when applying the selected published workflow.
...
| `package.json` | Maintainers/CI | Repository entry points for Skill build, freshness checks, validation, both generated-asset sample builds, and the aggregate release gate | active | Keep scripts as thin entry points; implementation details belong in the owning script. |
...
| `source/themes/green-ink/{SKILL.md,agents/,references/,recipe-guardrails/,component-overrides/,media/}` | Builder/maintainers | Canonical Green Ink instructions, A+B/C visual specification, controlled artwork index, presentation fragments, and pre-publication media | active | Keep the four-file artwork vocabulary and its paths synchronized with `references/art-assets.md`; update canonical inputs before generating `skills/green-ink/`. |
...
| `scripts/validate-skills.mjs` | Maintainers/CI | Canonical Markdown links plus installable Skill structure, recipe/asset coverage, CSS asset URLs, and manifest integrity validation | active | Change when the canonical/published link boundary, Skill contract, or inventory changes. |
...
| `skills/green-ink/` | Codex/Skill users/installers | Generated, self-contained installable Green Ink output, including instructions, references, copyable React assets, and four controlled WebP files | generated | Do not edit directly; update canonical sources or builder inputs and regenerate. |
| `skills/<theme>/manifest.json` | Builder/CI/installers | Generated file inventory and SHA-256 integrity record for each installable Skill | generated | Owned by `scripts/build-skills.mjs`; never edit by hand or include the manifest in its own inventory. |
...
| `skills/<theme>/SKILL.md` | `docs/ARCHITECTURE.md` | Each Skill owns execution guidance. Repository build boundaries and publication invariants stay in architecture. |
| `skills/<theme>/` | `source/themes/<theme>/` plus shared canonical sources | Installable Skills are deterministic generated outputs, not second maintenance sources; change canonical inputs and rebuild. |
