...
Installable React assets are generated under `skills/orange-matters/assets/react/`. Each public component and layout has a corresponding recipe; canonical source paths remain the maintenance inputs rather than published dependencies.
...
| L2 shared behavior/theme presentation | 6 | Button, Field, Header, Heading, Menubar, DashboardFrame |
...
| Present installable component assets | 14 | Every public component recipe maps to a generated asset under `skills/orange-matters/assets/react/components/` |
