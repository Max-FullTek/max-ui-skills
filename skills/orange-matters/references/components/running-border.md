...
Use the [canonical Orange-only RunningBorder component](../../assets/react/components/RunningBorder/). The Skill builder publishes its complete TSX, CSS Module, and barrel export under `assets/react/components/RunningBorder/`.
